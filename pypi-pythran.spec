...
Source0  : https://files.pythonhosted.org/packages/94/0a/95a72f09f25dae48f41e367959075ed4c7a0ff02dd3f54eec111501d648a/pythran-0.18.0.tar.gz
...
%prep
%setup -q -n pythran-0.18.0
cd %{_builddir}/pythran-0.18.0
pushd ..
cp -a pythran-0.18.0 buildavx2
popd
pushd ..
cp -a pythran-0.18.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748009233
